...
export default function Footer() {
  return (
    <footer className="bg-barley text-lg text-donkey font-medium fixed bottom-0 w-full flex justify-center items-center gap-12 py-3">
      <p>ACT IN</p>
      ...
      <section className="flex gap-2 items-center">
        ...
        <Link href="tel:+79625564290">+7 (962) 556 - 42 - 90</Link>
      </section>
    </footer>
  );
}
